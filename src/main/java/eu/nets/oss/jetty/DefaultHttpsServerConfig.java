...
public class DefaultHttpsServerConfig implements HttpsServerConfig {
    ...
    public DefaultHttpsServerConfig() {
        ...
        if (httpsServerPortProperty == null) { throw new IllegalArgumentException("Must have HTTPS Server port defined as system property 'https.server.port'.");}
        if (httpsServerKeyStorePathProperty == null) { throw new IllegalArgumentException("Must have key store resource/file defined as system property 'https.server.key.store.path'."); }
        if (httpsServerKeyStorePasswordProperty == null) { throw new IllegalArgumentException("Must have key store password defined as system property 'https.server.key.store.password'.");}
